  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        className="rounded-full border border-[var(--border)] bg-white/85 px-4 py-2 text-sm font-semibold text-[var(--foreground)]"
      >
        <span>Language</span>
        <span className="ml-3 text-xs text-[var(--muted)]">v</span>
      </button>
